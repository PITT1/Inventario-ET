...
await db.insert(Clientes).values([{ clientId: 123, nombre:"pedro", fecha:"03/04/2024", observaciones:"el motor estaba trancado" }])
...
await db.insert(Clientes).values([{ clientId: 123, nombre:"Ana", fecha:"09/11/2023", observaciones:"mantenimiento, cambio de rolineras" }])
